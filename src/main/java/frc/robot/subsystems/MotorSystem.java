...
public class MotorSystem extends SubsystemBase {
    ...
    public MotorSystem() {
        ...
        speedEncoderA = new Encoder(Constants.BallSpeedEncoderAID, Constants.BallSpeedEncoderBID, false, EncodingType.k4X);
        ...
        speedEncoderB = new Encoder(Constants.BallSpeedEncoderAID, Constants.BallSpeedEncoderBID, false, EncodingType.k4X);
